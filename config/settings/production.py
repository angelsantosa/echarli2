...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='echarli2 <noreply@echarli.com>')
...
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default='[echarli2] ')
SERVER_EMAIL = env('DJANGO_SERVER_EMAIL', default=DEFAULT_FROM_EMAIL)

NEW_RELIC_LICENSE_KEY = env('NEW_RELIC_LICENSE_KEY')
NEW_RELIC_APP_NAME = env('NEW_RELIC_APP_NAME')

EMAIL_HOST = env('EMAIL_HOST_PRODUCTION', default='localhost')
EMAIL_PORT = env('EMAIL_PORT_PRODUCTION', default='25')
