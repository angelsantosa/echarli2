(function() {
    ...
    angular
        .module('echarliApp')
        .directive('echSocial', echSocial);

    echSocial.$inject = ['$translatePartialLoader', '$translate', '$filter', 'SocialService'];

    function echSocial($translatePartialLoader, $translate, $filter, SocialService) {
        var directive = {
            restrict: 'E',
            scope: {
                provider: '@ngProvider'
